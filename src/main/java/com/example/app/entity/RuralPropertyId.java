...
public class RuralPropertyId implements Serializable {
    ...
    public RuralPropertyId(Integer presentationYear, String taxType, String presentationCode, String taxpayerNif, Integer assetSequence) {
