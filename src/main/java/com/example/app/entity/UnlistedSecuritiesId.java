...
public class UnlistedSecuritiesId implements Serializable {
    ...
    public UnlistedSecuritiesId(Integer presentationYear, String taxType, String presentationCode, String taxpayerNif, Integer assetSequence) {
