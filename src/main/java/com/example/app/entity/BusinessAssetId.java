...
public class BusinessAssetId implements Serializable {
    ...
    public BusinessAssetId(Integer presentationYear, String taxType, String presentationCode, String taxpayerNif, Integer assetSequence) {
